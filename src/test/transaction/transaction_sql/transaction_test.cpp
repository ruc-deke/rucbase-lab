...
std::string test_infiles[] = {"transaction_test/commit_test.sql", "transaction_test/abort_test.sql"};

std::string init_test_arguments(TestCase test_case) { return test_infiles[test_case]; }
